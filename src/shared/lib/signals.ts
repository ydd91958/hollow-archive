...
export const SIGNALS: Signal[] = [
  ...
  },
  {
     ...
     * 通往第三层的门。
     *
     * 四个条件，一个站一条：资料库的第十七号井、博客的那盘磁带、
     * 论坛被删的那条回复、气象站 1987-11-03 那天的记录。
     *
     * 玩家必须真的把四个互不相干的网站都走过一遍，这扇门才开。
     * 这不是收集要素，是这个游戏的论点本身：没有任何一个网站
     * 独自说得清那 41 分钟。
     */
    id: 'SIG_ATTACHMENT',
    requires: ['well:17', 'post:TAPE', 'reveal:BBS-DELETED', 'wx:1987-11-03'],
